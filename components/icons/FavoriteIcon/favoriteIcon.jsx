...
const FavoriteIcon = ({isFavorite}) => {
    ...
    const iconColor = selected ? '#e50010' : '#ffffff'

    const clickHandler = () => {
        setSelected((prev) => !prev)
    }

    return <span className={cls.icon} onClick={clickHandler}><svg
        className="IconWrapper-module--icon__BcwyJ IconWrapper-module--normal__vM609"
        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
        xmlnsXlink="http://www.w3.org/1999/xlink" focusable="false">
        <path
